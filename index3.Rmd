...
# }
    ...
    gw=getwd()
    myjpg <- paste0(gw,'/',paste("Linear Model Estimate Plot of",hip1,Group,".jpg"))
    # myjpg <- read.jpeg(myjpg)
    # plot(myjpg)
    
    library(jpeg);image <- readJPEG(myjpg);plot(image)
    # res = dim(image)[2:1]
    # rasterImage(image,1,1,res[1],res[2])
  ...
  corrplot(rs1, type = type, order = order,method=method, p.mat=rs2, tl.col = "black", cl.cex = cl.cex,pch.cex=pch.cex,pch.col='black',pch=pch,
           sig.level = sig.level,cl.pos = cl.pos, insig = "label_sig",cl.offset=cl.offset,cl.length=cl.length,
...
# }
  ...
  # packageurl <- "https://cran.r-project.org/src/contrib/Archive/ReadImages/ReadImages_0.1.3.3.tar.gz"
